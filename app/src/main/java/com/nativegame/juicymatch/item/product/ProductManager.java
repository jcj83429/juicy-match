...
public class ProductManager {
    ...
    public ProductManager(Activity activity) {
        ...
        Product productGlove = new Product(Item.GLOVE, 0, R.drawable.ui_booster_glove, R.drawable.ui_btn_yes);
        Product productBomb = new Product(Item.BOMB, 0, R.drawable.ui_booster_bomb, R.drawable.ui_btn_yes);
        Product productHammer = new Product(Item.HAMMER, 0, R.drawable.ui_booster_hammer, R.drawable.ui_btn_yes);
